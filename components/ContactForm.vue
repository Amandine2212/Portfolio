<script setup>
    ...
    function sendMail(message){
        ...
        || message.msg.length < 1 ){
            ...
            let mailto
            if(message.tel) {
                mailto = mailto:amandine.larrosa@outlook.fr
...
<template>
    <div id="contact">
        ...
        <div class="form__grid">
            ...
            <button class="Envoyer" @click="sendMail(message)">Envoyer</button>
        </div>
    </div>
</template>
...
<style scoped>
    ...
    input:focus, textarea:focus {
        box-shadow: -4px 4px 10pxrgb(204, 244, 134);
    }
    ...
    .messageErreur {
        display: flex;
        align-items: center;
        background-color: rgba(104, 3, 3, 0.76);
